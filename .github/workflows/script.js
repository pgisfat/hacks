...
await fetch("https://raw.githubusercontent.com/pgisfat/hacks/main/hacks.html").then(async x => document.querySelector("#unobfuscated").contentDocument.write(await x.text().then(x => x.slice(0, x.indexOf("<style")))));
